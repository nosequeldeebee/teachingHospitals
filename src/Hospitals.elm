...
view refreshedHospitals key =
    div []
        [ table []
            [ thead []
                [ tr []
                    [ th [] [ p [ onClick Msgs.SortName ] [ text "Name" ] ]
                    , th [] [ p [ onClick Msgs.SortAddress ] [ text "Address" ] ]
                    , th [] [ p [ onClick Msgs.SortCity ] [ text "City" ] ]
                    , th [] [ p [ onClick Msgs.SortState ] [ text "State" ] ]
                    , th [] [ p [ onClick Msgs.SortZip ] [ text "Zip" ] ]
                    ]
                ]
